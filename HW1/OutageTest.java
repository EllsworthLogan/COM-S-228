...
class OutageTest {
	...
	void censusTest() {
		Town usrTown = new Town(4, 4);
		usrTown.randomInit(10);
		usrTown.grid[0][0].census(usrTown.grid[0][0].nCensus);
	...
	void whoTest1() {
		Town usrTown = new Town(4, 4);
		usrTown.randomInit(10);
		assertFalse(usrTown.grid[0][1].who() == State.OUTAGE);
	}
	...
	/**
	 * Tests the State transformation for Outage
	 */
	@Test
	void nextTest() {
		Town usrTown = new Town(4, 4);
		usrTown.randomInit(10);
		assertTrue(usrTown.grid[0][0].next(usrTown).who() == State.EMPTY);
	}
